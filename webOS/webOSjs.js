...
// Registry to link windows to their taskbar icons
var appRegistry = [
...
// Bring window to front, update z-index, and highlight it
...
// Make windows focusable when clicked anywhere inside them
appRegistry.forEach(app => {
    if (app.window) {
...
// Check initial window state on page load
